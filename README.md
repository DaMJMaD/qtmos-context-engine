...
Use `/alpha/spawn` when you want one prompt fanned out across multiple lanes, with local Codex automation, manual browser lanes, cross-exam prompts, and a final foldback judge.
